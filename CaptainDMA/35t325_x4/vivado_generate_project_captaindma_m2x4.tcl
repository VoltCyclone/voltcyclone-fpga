#
# Vivado generated .tcl for creating the pcileech_35t325_x4 vivado project.
...
set _xil_proj_name_ "pcileech_35t325_x4"
...
set files [list \
 ...
 [file normalize "${origin_dir}/src/pcileech_35t325_x4_top.sv" ]\
]
...
set file "src/pcileech_35t325_x4_top.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "pcileech_35t325_x4_top" -objects $obj
...
# Copy COE files to bram_bar_zero4k IP directory (will be created later, but ensure COE is there)
file mkdir "$ip_base_dir/bram_bar_zero4k"
file copy -force "$coe_source_dir/pcileech_bar_zero4k.coe" "$ip_base_dir/bram_bar_zero4k/"

# Copy COE files to drom_pcie_cfgspace_writemask IP directory
file mkdir "$ip_base_dir/drom_pcie_cfgspace_writemask"
file copy -force "$coe_source_dir/pcileech_cfgspace_writemask.coe" "$ip_base_dir/drom_pcie_cfgspace_writemask/"
...
set file "[file normalize ${origin_dir}/src/pcileech_35t325_x4_captaindma_m2.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "src/pcileech_35t325_x4_captaindma_m2.xdc"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a35tcsg325-2 -flow {Vivado Synthesis 2023} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a35tcsg325-2 -flow {Vivado Implementation 2023} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
