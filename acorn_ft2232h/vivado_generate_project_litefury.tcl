#
# Vivado generated .tcl for creating the pcileech_acorn vivado project.
...
set _xil_proj_name_ "pcileech_litefury"
...
set orig_proj_dir "[file normalize "$origin_dir/pcileech_litefury"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/src/pcileech_ft245.sv"]\
 ...
 [file normalize "${origin_dir}/src/pcileech_acorn_top.sv"]\
]
...
set file "src/pcileech_ft245.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "src/pcileech_acorn_top.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "pcileech_acorn_top" -objects $obj
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/ip/fifo_32_8_clk1_comtx.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Set 'sources_1' fileset file properties for local files
set file "fifo_32_8_clk1_comtx/fifo_32_8_clk1_comtx.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
set file "[file normalize ${origin_dir}/src/pcileech_acorn.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "src/pcileech_acorn.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Set 'constrs_1' fileset properties
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/src/pcileech_acorn.xdc" -objects $obj
set_property -name "target_ucf" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/src/pcileech_acorn.xdc" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a100tfgg484-1 -flow {Vivado Implementation 2019} -strategy "Performance_ExtraTimingOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
