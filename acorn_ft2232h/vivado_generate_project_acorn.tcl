...
set _xil_proj_name_ "pcileech_acorn"
...
set orig_proj_dir "[file normalize "$origin_dir/pcileech_acorn"]"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a200tfbg484-3 -flow {Vivado Synthesis 2017} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
